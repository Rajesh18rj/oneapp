                    ...
                    <form action="{{route('admin.custom-role.update',[$role['id']])}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                             ...
                             <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="vehicle_type" class="form-check-input"
                                           id="vehicle_type"  {{in_array('vehicle_type',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label qcont text-dark" for="vehicle_type">{{translate('messages.vehicle_type')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="logistic_type" class="form-check-input"
                                           id="logistic_type"  {{in_array('logistic_type',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label qcont text-dark" for="logistic_type">{{translate('messages.logistic_type')}}</label>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="delivery_agent" class="form-check-input"
                                           id="delivery_agent"  {{in_array('delivery_agent',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label qcont text-dark" for="delivery_agent">{{translate('messages.delivery_agent')}}</label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label qcont text-dark" for="reviews">{{translate('messages.reviews')}}</label>
                                </div>
                            </div>
                            
                            <div class="col-md-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" name="modules[]" value="commodity_type" class="form-check-input"
                                           id="reviews" {{in_array('commodity_type',(array)json_decode($role['modules']))?'checked':''}}>
                                    <label class="form-check-label qcont text-dark" for="commodity_type">{{translate('messages.commodity_type')}}</label>
                                </div>
                            </div>
                        </div>
