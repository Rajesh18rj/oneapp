...
@section('title', translate('messages.edit_logistic_type'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header" style="border-bottom:0;padding-bottom:0;">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-edit"></i> {{ translate('messages.Edit') }}
                        Logistic Information</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{ route('admin.logistic_type.update', [$item->id]) }}" method="post" class="js-validate" id="vendor_form">
                    @csrf
                                  ...
                                  <?php
                                    ...
                                    if(isset($module_types) && !empty($module_types)){
                                      foreach($module_types as $key => $value){
                                   	  ...
                                   	  $selected = in_array($value->id,$module_type_id) ? "selected" : '';

                                  ?>
                                  <option value="{{$value->id}}" {{ $selected  }}>{{$value->module_name}}</option>
