    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('admin.module.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" value="1"
                                            name="customer_verification" id="all_zone_service1" onchange="handleInputChange(this)">
                                ...
                                <div class="form-control">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input" value="0"
                                            name="customer_verification" id="all_zone_service2" onchange="handleInputChange(this)">
                ...
                <div class="row">
                   <div class="col-sm-3 col-6 d-none" id="zone_section" style="left: 777px;position: relative;">
                                <div class="form-group">
