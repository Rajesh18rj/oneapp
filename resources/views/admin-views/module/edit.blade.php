...
@section('title',translate('messages.Update module'))
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('admin.module.update',[$module['id']])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="all_zone_service" id="all_zone_service1" {{$module->all_zone_service == 1? 'checked': ''}} onchange="handleInputChange(this)">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="all_zone_service" id="all_zone_service2" {{$module->all_zone_service == 0? 'checked': ''}}  onchange="handleInputChange(this)">
                     ...
                     <div class="row">
                           <div class="col-sm-3 col-6 {{$module->all_zone_service == 1? 'd-none': ''}}" id="zone_section" style="left: 777px;position: relative;">
                                <div class="form-group">
                                    <label class="input-label" for="exampleFormControlInput1">{{ translate('messages.zone') }}<span style="color:red;">*</span></label>
                                    <select name="zone_id" id="zone_id" class="form-control"
                                        data-placeholder="{{ translate('messages.select') }} {{ translate('messages.zone') }}">
                                        <option value="">{{ translate('messages.select') }} {{ translate('messages.zone') }}</option>
                                        <?php
                                        foreach (\App\Models\Zone::active()->get() as $zone){

                                               
                                               $selected = ($module->zone_id == $zone->id) ? "selected=selected" : '';
...
@push('script_2')
    <script>
    function handleInputChange(ele){
	 if($(ele).val() == '0'){
