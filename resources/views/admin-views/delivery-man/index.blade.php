        ...
        <!-- End Page Header -->
          ...
          <div class="row">
                ...
                <div class="border m-3 p-3 col-12">
                    <form class="card-body" action="{{ route('admin.delivery-man.store') }}" method="post"
                        ...
                        <div class="row mt-3">
                            ...
                            <input type="hidden" name="delivery_type" class="form-control" id="delivery_type" value="{{ $type }}">
