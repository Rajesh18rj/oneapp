        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{ translate('messages.welcome') }}, {{ auth('admin')->user()->f_name }}.
                    </h1>
            ...
            <div class="row gx-2 gx-lg-3">
                        ...
                        <div class="card-header">
                            ...
                            <select class="custom-select" style="width: 30%" name="user_overview"
                                ...
                                <option value="this_month"
                                    {{ $params['user_overview'] == 'this_month' ? 'selected' : '' }}>
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="card h-100" id="top-selling-foods-view">
                        @include('admin-views.partials._top-selling-foods', [
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="card h-100" id="popular-restaurants-view">
                        @include('admin-views.partials._popular-restaurants', [
                ...
                <div class="col-lg-6 mt-3">
                    ...
                    <div class="card h-100" id="top-rated-foods-view">
                        @include('admin-views.partials._top-rated-foods', [
                ...
                <div class="col-lg-6 mt-3">
                    ...
                    <div class="card h-100" id="top-deliveryman-view">
                        @include('admin-views.partials._top-deliveryman', [
                ...
                <div class="col-lg-6 mt-3">
                    ...
                    <div class="card h-100" id="top-restaurants-view">
                        @include('admin-views.partials._top-restaurants', [
