                            ...
                            <div class="form-group">
                                ...
                                <select name="attribute_id[]" id="choice_attributes"
                                    ...
                                    @foreach($attributes as $attribute)
                                    	@if(!empty(json_decode($product['attributes'])))
                    ...
                    <div class="row"  id="time_input">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$product['video_url']}}" name="video_url" class="form-control" />
                            </div>
                        </div>
...
@push('script_2')
    <script>
        ...
        $(document).ready(function () {
       	    ...
       	    @if(!empty(json_decode($product['add_ons'], true))) 	
