    ...
    <main id="content" role="main" class="main">
        ...
        <div class="container py-5 py-sm-7">
            ...
            <a class="d-flex justify-content-center mb-5" href="javascript:">
                <img class="z-index-2" onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <!-- Form -->
                            <form class="" action="{{ route('admin.auth.login') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                        <h2 class="text-capitalize">{{ translate('messages.signin') }}</h2>
                                        <span class="badge badge-soft-info">(
                                            {{ translate('messages.admin_or_employee_signin') }} )</span>
                                        <p>{{ translate('messages.want') }} {{ translate('messages.to') }}
                                            {{ translate('messages.login') }} {{ translate('messages.your') }}
                                         ...
                                         <p>{{translate('messages.want_to_login_your_delivery_agent_account')}}?
                                            <a href="{{ route('delivery-agent.auth.login') }}">
                                                {{ translate('messages.delivery_agent') }} {{ translate('messages.login') }}
                                            </a>
                                        </p>
                                    </div>
                                ...
                                <div class="js-form-message form-group">
                                    <label class="input-label text-capitalize"
                                        for="signinSrEmail">{{ translate('messages.your') }}
                                ...
                                <div class="row p-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control form-control-lg" name="custome_recaptcha"
                                               id="custome_recaptcha" required placeholder="{{\translate('Enter recaptcha value')}}" style="border: none" autocomplete="off" value="{{env('APP_MODE')=='dev'? session('six_captcha'):''}}">
                                    </div>
                            ...
                            @endif --}}
                                ...
                                <button type="submit"
                                    class="btn btn-lg btn-block btn-primary">{{ translate('messages.sign_in') }}</button>
                            </form>
                            <!-- End Form -->
                        </div>
