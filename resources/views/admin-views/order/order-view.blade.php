   ...
   /* echo "<pre>";
    ...
    <div class="content container-fluid">
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    ...
                    <div class="mt-2">
                        ...
                        <a class="text-body mr-3" href={{ route('admin.order.download-invoice', [$order['id']]) }}>
                            <i class="tio-download mr-1"></i> Download {{ translate('messages.invoice') }}
                        </a>
        ...
        <!-- End Page Header -->
            ...
            <?php
            if($parcel_order){
                $frieghtfilenamesString = $order['frieght_attachments'];
                $frieghtfilenamesArray = json_decode($frieghtfilenamesString);

                $insurancefilenamesString = $order['insurance_attachments'];
                $insurancefilenamesArray = json_decode($insurancefilenamesString);
            ?>
               <h5 >   Frieght Attachments - </h5>
         

            <div class="row">
                @if (!empty($frieghtfilenamesArray))
                    @foreach ($frieghtfilenamesArray as $data)
                        <div class="col-xl-4 col-md-4 col-sm-6 col-6">
                            <img  src="{{ url('storage/app/public') }}/order/{{ $data }}" alt="Image" style="height: 200px;width:200px;border: 1px solid; border-radius: 10px;cursor:pointer;" class="document">
                          
                        </div>
                    @endforeach
                @else
                    <p class="p-5">No freight attachments available.</p>
                @endif
            </div>
            <h5>Insurance Attachments -  </h5>
            

             <div class="row">
                @if (!empty($insurancefilenamesArray))
                    @foreach ($insurancefilenamesArray as $data)
                        <div class="col-md-4">
                           <img  src="{{ url('storage/app/public') }}/order/{{ $data }}" alt="Image" style="height: 200px;width:200px;border: 1px solid; border-radius: 10px;cursor:pointer;" class="document">
                    ...
                    @endforeach
                @else
                    <p class="p-5">No insurance attachments available.</p>
                @endif
            </div>
    <?php } ?>
            ...
            <div class="col-lg-8 mb-3 mb-lg-0">
                        ...
                        <div class="row">
                            <div class="col-12 pb-2 border-bottom  d-flex justify-content-between">
                                <h4 class="card-header-title">
                                    ...
                                    <span
                                        class="badge badge-soft-dark rounded-circle ml-1">  {{ (count($products))}} </span>
                                </h4>
                        ...
                        <div class="row">
                            <div class="col-6 pt-2">
                                ...
                                @if ($order->order_attachment)
                                    <h5 class="text-dark">
                                        {{ translate('messages.invoice_image') }}:
                                    </h5>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel">
                                                        {{ translate('messages.invoice_image') }}</h4>
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    ...
                                    if($order['order_type'] == 'parcel'){
                                      $vehicle_type_data = \App\Models\VehicleType::where('id',$order['vehicle_type_id'])->first();
                                      $logistic_type_data = \App\Models\LogisticType::where('id',$order['logistic_type_id'])->first();
                                    
                                    ?>
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.vehicle') }}
                                        {{ translate('messages.type') }}
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $vehicle_type_data ? $vehicle_type_data->name : 'N/A'  }}</label>
                                    </h6>
                                    
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.logisitic') }}
                                        {{ translate('messages.type') }}
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $logistic_type_data ? $logistic_type_data->name : 'N/A' }}</label>
                                    </h6>
                                    
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.description') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['description'] ?? 'N/A' }}</label>
                                    </h6>
                                    
                                    
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.cargo_number') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['cargo_number'] ?? 'N/A' }}</label>
                                    </h6>
                                    
                                    
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.container_id') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['container_id'] ?? 'N/A' }}</label>
                                    </h6>
                                    
                                    
                                    <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.insurance_price') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['insurance_number'] ?? 'N/A' }}</label>
                                    </h6>
                                    
                                      <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.insurance_number') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['insurance_number'] ?? 'N/A' }}</label>
                                    </h6>
                                    
                                      <h6 class="text-capitalize" style="color: #8a8a8a;">{{ translate('messages.invoice_value') }}
                                  
                                        : <label style="font-size: 10px"
                                            class="badge badge-soft-primary">{{ $order['invoice_value'] ?? 'N/A' }}</label>
                                    </h6>
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="row">
                                        ...
                                        <div class="col col-md-2 align-self-center text-right  d-none">
                                         ...
                                         <div class="col col-md-2 align-self-center text-right ">
                                            <h6>{{ translate('Vehicle Price') }}</h6>
                                            <span>{{ \App\CentralLogics\Helpers::format_currency($order->vehicle_price) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                           ...
                           // echo "<pre>";
                            ...
                            @foreach ($details as $key => $detail)
                                @if (isset($detail->item_id) && $detail->status)
                                    ...
                                    $productData =  \App\CentralLogics\ProductLogic::get_product($detail->item_id ?? '');                 
            	...
            	$amount = $detail['price'] * $detail['quantity'];
                                    ...
                                    <div class="media">
                                        ...
                                        @else
                                            <a class=" {{$class}} avatar avatar-xl mr-3"
                                        ...
                                        <div class="media-body {{$class}}">
                                            <div class="row">
                                                <div class="col-md-6 mb-3 mb-md-0">
                                                    <strong>
                                                        {{ Str::limit($detail->item['name'], 20, '...') }}</strong><br>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    ...
                                    ?>
                                        {{ \App\CentralLogics\Helpers::format_currency($vehicle_price) }}
                                        
                                        
                                        <?php } else { ?>
                                        
                                                   {{ \App\CentralLogics\Helpers::format_currency($product_price + $del_c + $total_tax_amount + $total_addon_price - $coupon_discount_amount - $store_discount_amount) }}
