            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add') }}
                        {{ translate('messages.new') }} {{ translate('messages.store') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{ route('admin.vendor.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="address" class="form-control"
                                    placeholder="{{ translate('messages.store') }} {{ translate('messages.address') }}" required>{{ old('address') }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="maximum_delivery_time" class="form-control"
                                        placeholder="Max: 20" value="{{ old('maximum_delivery_time') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            <div class="form-group">
                                ...
                                <select id="module_id" name="module_id" required class="form-control js-select2-custom"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="gst_number" name="gst_number" class="form-control"
                                    placeholder="{{ translate('messages.gst_number') }}" value="{{ old('gst_number') }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6 col-12 fssai_number_section">
                            <div class="form-group">
                                ...
                                <input type="text" id="fssai_number" name="fssai_number" class="form-control"
                                    ...
                                    value="{{ old('fssai_number') }}" required>
                            </div>
                        </div>
                    ...
                    <small class="nav-subtitle text-secondary border-bottom">{{ translate('messages.owner') }}
                        {{ translate('messages.info') }}</small>
                    <br>
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control" name="password"
                                        ...
                                        aria-label="{{ translate('messages.password_length_placeholder', ['length' => '9+']) }}"
