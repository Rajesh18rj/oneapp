...
@section('title', translate('messages.edit_commodity_type'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{ route('admin.commodity_type.update', [$item->id]) }}" method="post" class="js-validate" id="vendor_form">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label class="input-label" for="name">{{ translate('messages.commodity') }}
                                    {{ translate('messages.name') }}</label>
                                <input type="text" name="name" class="form-control"
                                    placeholder="{{ translate('messages.Commodity') }} {{ translate('messages.name') }}"
