                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    onclick="form_alert('category-{{$category['id']}}','Want to delete this category')" title="{{translate('messages.delete')}} {{translate('messages.category')}}"><i class="tio-delete-outlined"></i>
                                      ...
                                      <label class="toggle-switch toggle-switch-sm" style="display:inline-block!important;" for="stocksCheckbox1{{$category->id}}">
                                    <input type="checkbox" onclick="location.href='{{route('admin.parcel.category.insurance-field-status',[$category['id'],$category->insurance_field_status?0:1])}}'"class="toggle-switch-input" id="stocksCheckbox1{{$category->id}}" {{$category->insurance_field_status?'checked':''}} >
                                        <span class="toggle-switch-label">
                                            <?php
                                              $title = ($category->insurance_field_status == '0') ? 'Enable insurance field'  : 'Disable insurance field'; 
                                            
                                            ?>
                                            <span class="toggle-switch-indicator" title="{{$title}}"></span>
                                        </span>
                                    </label>
