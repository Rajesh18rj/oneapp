        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize">{{ translate('messages.business') }}
                ...
                <form action="{{ route('admin.business-settings.update-setup') }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline text-capitalize">{{ translate('messages.time_zone') }}</label>
                                <select name="timezone" class="form-control js-select2-custom">
                                    ...
                                    <option value="Atlantic/Cape_Verde"
                                        {{ $tz ? ($tz == 'Atlantic/Cape_Verde' ? 'selected' : '') : '' }}>(GMT-01:00) Cape
                                        Verde Is.
                                    </option>
                        ...
                        <div class="col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline text-capitalize">{{ translate('messages.time_format') }}</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.scheduled') }}
                                    {{ translate('messages.orders') }}</label><small style="color: red">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="schedule_order" id="schedule_order2"
                                                {{ $schedule_order == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                        ...
                        <div class="col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.order_confirmation_model') }}</label><small
                                    style="color: red">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.store_cancellation_toggle') }}</label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="{{ translate('messages.customer_varification_toggle') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.customer_varification_toggle') }}"></span> -->
                                    *
                                </small>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.deliveryman_cancellation_toggle') }}</label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="{{ translate('messages.customer_varification_toggle') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.customer_varification_toggle') }}"></span> -->
                                    *
                                </small>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.show_earning_for_each_order') }}</label><small
                                    style="color: red">
                                    <!-- <span class="input-label-secondary" title="{{ translate('messages.customer_varification_toggle') }}"><img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.customer_varification_toggle') }}"></span> -->
                                    *
                                </small>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.admin') }}
                                    ...
                                    {{ translate('messages.notification') }}</label><small style="color: red">*</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.customer') }}
                                    {{ translate('messages.verification') }}</label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            alt="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                ...
                                                {{ $ev == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="ev1">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="customer_verification" id="ev2"
                                                {{ $ev == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="odc" id="odc2" {{ $odc == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.veg') }}/{{ translate('messages.non_veg') }}</label><small
                                    style="color: red"><span class="input-label-secondary"
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="vnv" id="vnv2" {{ $vnv == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                        ...
                        <div class="col-md-4 col-12">
                            @php($ev = \App\Models\BusinessSetting::where('key', 'deliveryman_deposit')->first())
                            @php($ev = $ev ? $ev->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }}
                                    {{ translate('messages.Deposit') }}</label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            alt="{{ translate('messages.customer_varification_toggle') }}"></span>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="deliveryman_deposit" id="ev11"
                                                {{ $ev == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="ev11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="deliveryman_deposit" id="ev22"
                                                {{ $ev == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="ev22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.store_self_registration') }}</label><small
                                    style="color: red"><span class="input-label-secondary"
                                        title="{{ translate('messages.store_self_registration') }}"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            alt="{{ translate('messages.store_self_registration') }}"></span> *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label
                                    class="input-label d-inline">{{ translate('messages.dm_self_registration') }}</label><small
                                    style="color: red"><span class="input-label-secondary"
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.GST_Certificate') }}
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    <!-- Custom Radio -->
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_gst_certificate_enabled" id="is_gst_certificate_enabled11"
                                                {{ $is_gst_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_gst_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_gst_certificate_enabled" id="is_gst_certificate_enabled22"
                                                {{ $is_gst_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_gst_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.PAN_Card') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_pan_card_enabled" id="is_pan_card_enabled11"
                                                {{ $is_pan_card_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pan_card_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_pan_card_enabled" id="is_pan_card_enabled22"
                                                {{ $is_pan_card_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pan_card_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                         ...
                         <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.CIN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_cin_certificate_enabled" id="is_cin_certificate_enabled11"
                                                {{ $is_cin_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_cin_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_cin_certificate_enabled" id="is_cin_certificate_enabled22"
                                                {{ $is_cin_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_cin_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            @php($is_abn_certificate_enabled = $is_abn_certificate_enabled ? $is_abn_certificate_enabled->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.ABN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_abn_certificate_enabled" id="is_abn_certificate_enabled11"
                                                {{ $is_abn_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_abn_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_abn_certificate_enabled" id="is_abn_certificate_enabled22"
                                                {{ $is_abn_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_abn_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.TFN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_tfn_certificate_enabled" id="is_tfn_certificate_enabled11"
                                                {{ $is_tfn_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_tfn_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_tfn_certificate_enabled" id="is_tfn_certificate_enabled22"
                                                {{ $is_tfn_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_tfn_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            @php($is_acn_certificate_enabled = $is_acn_certificate_enabled ? $is_acn_certificate_enabled->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.ACN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_acn_certificate_enabled" id="is_acn_certificate_enabled11"
                                                {{ $is_acn_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_acn_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_acn_certificate_enabled" id="is_acn_certificate_enabled22"
                                                {{ $is_acn_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_acn_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            @php($is_ein_certificate_enabled = $is_ein_certificate_enabled ? $is_ein_certificate_enabled->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Delivery_man') }} {{ translate('messages.ein_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_ein_certificate_enabled" id="is_ein_certificate_enabled11"
                                                {{ $is_ein_certificate_enabled == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_ein_certificate_enabled11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_ein_certificate_enabled" id="is_ein_certificate_enabled22"
                                                {{ $is_ein_certificate_enabled == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_ein_certificate_enabled22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_gst_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_gst_certificate_enabled_for_vendor')->first())
                            @php($is_gst_certificate_enabled_for_vendor = $is_gst_certificate_enabled_for_vendor ? $is_gst_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.GST_Certificate') }}
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_gst_certificate_enabled_for_vendor" id="is_gst_certificate_enabled_for_vendor11"
                                                {{ $is_gst_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_gst_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_gst_certificate_enabled_for_vendor" id="is_gst_certificate_enabled_for_vendor22"
                                                {{ $is_gst_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_gst_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_fssai_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_fssai_certificate_enabled_for_vendor')->first())
                            @php($is_fssai_certificate_enabled_for_vendor = $is_fssai_certificate_enabled_for_vendor ? $is_fssai_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.fssai_Certificate') }}
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_fssai_certificate_enabled_for_vendor" id="is_fssai_certificate_enabled_for_vendor11"
                                                {{ $is_fssai_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_fssai_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_fssai_certificate_enabled_for_vendor" id="is_fssai_certificate_enabled_for_vendor22"
                                                {{ $is_fssai_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_fssai_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_pan_card_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_pan_card_enabled_for_vendor')->first())
                            @php($is_pan_card_enabled_for_vendor = $is_pan_card_enabled_for_vendor ? $is_pan_card_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.PAN_Card') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_pan_card_enabled_for_vendor" id="is_pan_card_enabled_for_vendor11"
                                                {{ $is_pan_card_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pan_card_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_pan_card_enabled_for_vendor" id="is_pan_card_enabled_for_vendor22"
                                                {{ $is_pan_card_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pan_card_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                         ...
                         <div class="col-md-4 col-12">
                            @php($is_cin_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_cin_certificate_enabled_for_vendor')->first())
                            @php($is_cin_certificate_enabled_for_vendor = $is_cin_certificate_enabled_for_vendor ? $is_cin_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.CIN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_cin_certificate_enabled_for_vendor" id="is_cin_certificate_enabled_for_vendor11"
                                                {{ $is_cin_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_cin_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_cin_certificate_enabled_for_vendor" id="is_cin_certificate_enabled_for_vendor22"
                                                {{ $is_cin_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_cin_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_abn_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_abn_certificate_enabled_for_vendor')->first())
                            @php($is_abn_certificate_enabled_for_vendor = $is_abn_certificate_enabled_for_vendor ? $is_abn_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.ABN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_abn_certificate_enabled_for_vendor" id="is_abn_certificate_enabled_for_vendor11"
                                                {{ $is_abn_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_abn_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_abn_certificate_enabled_for_vendor" id="is_abn_certificate_enabled_for_vendor22"
                                                {{ $is_abn_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_abn_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_tfn_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_tfn_certificate_enabled_for_vendor')->first())
                            @php($is_tfn_certificate_enabled_for_vendor = $is_tfn_certificate_enabled_for_vendor ? $is_tfn_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.TFN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_tfn_certificate_enabled_for_vendor" id="is_tfn_certificate_enabled_for_vendor11"
                                                {{ $is_tfn_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_tfn_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_tfn_certificate_enabled_for_vendor" id="is_tfn_certificate_enabled_for_vendor22"
                                                {{ $is_tfn_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_tfn_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_acn_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_acn_certificate_enabled_for_vendor')->first())
                            @php($is_acn_certificate_enabled_for_vendor = $is_acn_certificate_enabled_for_vendor ? $is_acn_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.ACN_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_acn_certificate_enabled_for_vendor" id="is_acn_certificate_enabled_for_vendor11"
                                                {{ $is_acn_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_acn_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_acn_certificate_enabled_for_vendor" id="is_acn_certificate_enabled_for_vendor22"
                                                {{ $is_acn_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_acn_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            @php($is_ein_certificate_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_ein_certificate_enabled_for_vendor')->first())
                            @php($is_ein_certificate_enabled_for_vendor = $is_ein_certificate_enabled_for_vendor ? $is_ein_certificate_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.ein_Certificate') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_ein_certificate_enabled_for_vendor" id="is_ein_certificate_enabled_for_vendor11"
                                                {{ $is_ein_certificate_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_ein_certificate_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_ein_certificate_enabled_for_vendor" id="is_ein_certificate_enabled_for_vendor22"
                                                {{ $is_ein_certificate_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_ein_certificate_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
...
<div class="col-md-4 col-12">
                            @php($is_bank_cheque_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_bank_cheque_enabled_for_vendor')->first())
                            @php($is_bank_cheque_enabled_for_vendor = $is_bank_cheque_enabled_for_vendor ? $is_bank_cheque_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.bank_cheque') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_bank_cheque_enabled_for_vendor" id="is_bank_cheque_enabled_for_vendor11"
                                                {{ $is_bank_cheque_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_bank_cheque_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_bank_cheque_enabled_for_vendor" id="is_bank_cheque_enabled_for_vendor22"
                                                {{ $is_bank_cheque_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_bank_cheque_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
...
<div class="col-md-4 col-12">
                            @php($is_pasbook_image_enabled_for_vendor = \App\Models\BusinessSetting::where('key', 'is_pasbook_image_enabled_for_vendor')->first())
                            @php($is_pasbook_image_enabled_for_vendor = $is_pasbook_image_enabled_for_vendor ? $is_pasbook_image_enabled_for_vendor->value : 0)
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Vendor') }} {{ translate('messages.pasbook_image') }} 
                                   </label><small style="color: red"><span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.customer_varification_toggle') }}"></span>
                                    *</small>
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="1"
                                                name="is_pasbook_image_enabled_for_vendor" id="is_pasbook_image_enabled_for_vendor11"
                                                {{ $is_pasbook_image_enabled_for_vendor == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pasbook_image_enabled_for_vendor11">{{ translate('messages.on') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            <input type="radio" class="custom-control-input" value="0"
                                                name="is_pasbook_image_enabled_for_vendor" id="is_pasbook_image_enabled_for_vendor22"
                                                {{ $is_pasbook_image_enabled_for_vendor == 0 ? 'checked' : '' }}>
                                            <label class="custom-control-label"
                                                for="is_pasbook_image_enabled_for_vendor22">{{ translate('messages.off') }}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                ...
                                <input type="number" name="admin_commission" class="form-control" id="admin_commission"
                                    value="{{ $admin_commission ? $admin_commission->value : 0 }}" min="0"
                                    max="100" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize"
                                    for="deliveryman_deposit_amount">{{ translate('messages.delivery_man_deposit_amount') }}</label>
                                <input type="number" name="deliveryman_deposit_amount" class="form-control"
                                    id="deliveryman_deposit_amount" min="0"
                                    value="{{ $deliveryman_deposit_amount ? $deliveryman_deposit_amount->value : 0 }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            @php($delivery_man_commission = \App\Models\BusinessSetting::where('key', 'delivery_man_commission')->first())
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize"
                                    for="delivery_man_commission">{{ translate('messages.default_delivery_man_commission') }}</label>
                                <input type="number" name="delivery_man_commission" class="form-control"
                                    id="delivery_man_commission"
                                    value="{{ $delivery_man_commission ? $delivery_man_commission->value : 0 }}"
                                    min="0" max="100" required>
                            </div>
                        </div>

                        <div class="col-md-6 col-12">
                            @php($channel_partner_commission = \App\Models\BusinessSetting::where('key', 'channel_partner_commission')->first())
                            <div class="form-group p-2">
                                <label class="input-label text-capitalize"
                                    for="channel_partner_commission">{{ translate('messages.default_channel_partner_commission') }}</label>
                                <input type="number" name="channel_partner_commission" class="form-control"
                                    id="channel_partner_commission"
                                    value="{{ $channel_partner_commission ? $channel_partner_commission->value : 0 }}"
                                    min="0" max="100" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group p-2 border">
                                ...
                                <input type="number" name="free_delivery_over" class="form-control"
                                    ...
                                    step=".01" required {{ isset($free_delivery_over->value) ? '' : 'readonly' }}>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline text-capitalize"
                                    ...
                                    style="color: red"><span class="input-label-secondary"
                                        title="{{ translate('messages.dm_maximum_order_hint') }}"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                            alt="{{ translate('messages.dm_maximum_order_hint') }}"></span> *</small>
                            ...
                            <div class="form-group">
                                <label class="input-label text-capitalize d-inline"
                                    for="latitude">{{ translate('messages.latitude') }}<span
                                        class="input-label-secondary"
                                        title="{{ translate('messages.click_on_the_map_select_your_defaul_location') }}"><img
                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" value="" name="footer_text" class="form-control" placeholder="" required>{{ $footer_text->value ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                    
                     <div class="row">
                        @php($cookie_text = \App\Models\BusinessSetting::where('key', 'cookie_text')->first())
                        <div class="col-12">
                            <div class="form-group">
                                <label class="input-label d-inline" for="exampleFormControlInput1">{{ translate('messages.cookie') }} {{ translate('messages.text') }}</label>
                                <textarea type="text" value="" name="cookie_text" class="form-control" placeholder="" required>{{ $cookie_text->value ?? '' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.logo') }}</label><small
                                    style="color: red">* ( {{ translate('messages.ratio') }} 3:1 )</small>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label class="input-label d-inline">{{ translate('messages.Fav Icon') }}</label><small
                                    style="color: red">* ( {{ translate('messages.ratio') }} 1:1 )</small>
                                <div class="custom-file mb-3">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            @php($gst_certificate = \App\Models\BusinessSetting::where('key', 'gst_certificate')->first())
                            @php($gst_certificate = $gst_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload GST Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="gst_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        id="gst_certificate_viewer"
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $gst_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            @php($fssai_certificate = \App\Models\BusinessSetting::where('key', 'fssai_certificate')->first())
                            @php($fssai_certificate = $fssai_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload FSSAI Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="fssai_certificate"
                                        class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        id="fssai_certificate_viewer"
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $fssai_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            @php($pan_card = \App\Models\BusinessSetting::where('key', 'pan_card')->first())
                            @php($pan_card = $pan_card->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload PAN Card</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="pan_card" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        id="pan_card_viewer"
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $pan_card) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            @php($tfn_certificate = \App\Models\BusinessSetting::where('key', 'tfn_certificate')->first())
                            @php($tfn_certificate = $tfn_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload TFN Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="tfn_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        ...
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $tfn_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            @php($acn_certificate = \App\Models\BusinessSetting::where('key', 'acn_certificate')->first())
                            @php($acn_certificate = $acn_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload ACN Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="acn_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        ...
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $acn_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            @php($abn_certificate = \App\Models\BusinessSetting::where('key', 'abn_certificate')->first())
                            @php($abn_certificate = $abn_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload ABN Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="abn_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        ...
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $abn_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            @php($ein_certificate = \App\Models\BusinessSetting::where('key', 'ein_certificate')->first())
                            @php($ein_certificate = $ein_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload EIN Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="ein_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        ...
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $ein_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            @php($cin_certificate = \App\Models\BusinessSetting::where('key', 'cin_certificate')->first())
                            @php($cin_certificate = $cin_certificate->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Upload CIN Certificate</label>
                                <div class="custom-file mb-3">
                                    <input type="file" name="cin_certificate" class="custom-file-input upload_docs"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                        for="customFileEg1">{{ translate('messages.choose') }}
                                        {{ translate('messages.file') }}</label>
                                ...
                                <center>
                                    <img style="height: 100px;border: 1px solid; border-radius: 10px;"
                                        ...
                                        onerror="this.src='{{ asset('public/assets/admin/img/160x160/img2.jpg') }}'"
                                        src="{{ asset('storage/app/public/business/' . $cin_certificate) }}"
                                        alt="logo image" />
                                </center>
                            </div>
                        </div>
   ...
   <div class="col-sm-6">
                            @php($min_delivery_man_amount = \App\Models\BusinessSetting::where('key', 'min_delivery_man_amount')->first())
                            @php($min_delivery_man_amount = $min_delivery_man_amount->value ?? '')
                            <div class="form-group">
                                <label class="input-label d-inline">Minimum delivery man amount (for freelancer) </label>
                                <div class="custom-file mb-3">
                                    <input type="text" name="min_delivery_man_amount" class="form-control"
                                       value="{{$min_delivery_man_amount}}">
		        	...
		        	<div class="col-sm-12">
			             <div class="form-group">
			                <label class="input-label d-inline">Deposit Note for delivery man signup</label>
			                <div class="custom-file mb-3">
			                    <textarea name="deposit_note" class="form-control ckeditor">{!! $deposit_note !!}</textarea>
			                </div>
		              	    </div>
		                </div>
                         </div>
		        	...
		        	<div class="col-sm-12">
			             <div class="form-group">
			                <label class="input-label d-inline">Courier Note for delivery man signup</label>
			                <div class="custom-file mb-3">
			                    <textarea name="courier_note" class="form-control ckeditor">{!! $courier_note !!}</textarea>
			                </div>
		              	    </div>
		                </div>
                         </div>
...
<script src="//cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
    <script>
      $(document).ready(function () {
        ...
        function previewDoc(input, viewer) {
