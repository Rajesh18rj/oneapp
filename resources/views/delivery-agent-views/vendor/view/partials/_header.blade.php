    ...
    <div class="page-header">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{request('tab')=='reviews'?'active':''}}" href="{{route('admin.vendor.view', ['store'=>$store->id, 'tab'=> 'reviews'])}}"  aria-disabled="true">{{translate('messages.reviews')}}</a>
                </li>
                 <li class="nav-item">
                    <a class="nav-link  {{request('tab')=='documents'?'active':''}}" href="{{route('admin.vendor.view', ['store'=>$store->id, 'tab'=> 'documents'])}}"  aria-disabled="true">{{translate('messages.documents')}}</a>
                </li>
            </ul>
            <!-- End Nav -->
        </div>
