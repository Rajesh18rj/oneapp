<div class="col-12">
        ...
        <a class="card card-hover-shadow h-100" href="{{ route('admin.dispatch.list', ['searching_for_deliverymen']) }}"
            ...
            <div class="card-body">
                <h6 class="card-subtitle" style="color: white!important;">
                    {{ translate('order_texts.searching_for_delivery_man') }}</h6>
    ...
    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
        ...
        <a class="card card-hover-shadow h-100" href="{{ route('admin.order.list', ['accepted']) }}"
            ...
            <div class="card-body">
                <h6 class="card-subtitle" style="color: white!important;">
                    {{ translate('order_texts.accepted_by_delivery_man') }}</h6>
    ...
    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
        ...
        <a class="card card-hover-shadow h-100" href="{{ route('admin.order.list', ['processing']) }}"
            ...
            <div class="card-body">
                <h6 class="card-subtitle" style="color: white!important;">
                    {{ translate('order_texts.preparing_in_restaurants') }}</h6>
    ...
    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
        <!-- Card -->
        <a class="card card-hover-shadow h-100" href="{{ route('admin.order.list', ['item_on_the_way']) }}"
            style="background: #4D6F72;">
            <div class="card-body">
                <h6 class="card-subtitle" style="color: white!important;">{{ translate('order_texts.picked_up') }}</h6>
            ...
            <div class="row gx-lg-4">
                <div class="col-sm-6 col-lg-3">
                    <div class="media" style="cursor: pointer"
                        ...
                        <span class="icon icon-sm icon-soft-primary icon-circle ml-3">
                ...
                <div class="col-sm-6 col-lg-3 column-divider-sm">
                    <div class="media" style="cursor: pointer"
                        ...
                        <div class="media-body">
                            <h6 class="card-subtitle">{{ translate('messages.canceled') }}</h6>
                ...
                <div class="col-sm-6 col-lg-3 column-divider-lg">
                    <div class="media" style="cursor: pointer"
                        ...
                        <div class="media-body">
                            <h6 class="card-subtitle">{{ translate('messages.payment') }}
                                {{ translate('messages.failed') }}</h6>
    ...
    <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
        ...
        <a class="card card-hover-shadow h-100"
            href="{{ route('admin.dispatch.list', ['searching_for_deliverymen']) }}" style="background: #0468A6;">
            <div class="card-body">
                <h6 class="card-subtitle" style="color: white!important;">
                    {{ translate('Channel_Partner_Commission') }}</h6>
                <div class="row align-items-center gx-2 mb-1">
                    <div class="col-6">
                        <span class="card-title h2" style="color: white!important;">
                            {{-- {{ $data['searching_for_dm'] }} --}}

                            {{ \App\CentralLogics\Helpers::format_currency(5000) }}
