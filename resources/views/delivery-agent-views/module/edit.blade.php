...
@section('title',translate('messages.Update System Module'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <form action="{{route('delivery-agent.module.update',[$module['id']])}}" method="post" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
...
@push('script_2')
    <script>
        ...
        {
            $.get({
                url: "{{url('/')}}/delivery-agent/module/type/?module_type="+id,
                dataType: 'json',
