    ...
    <div class="content container-fluid">
            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add') }}
                        {{ translate('messages.new') }} {{ translate('messages.sub_category') }}
                    </h1>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5>{{ isset($category) ? translate('messages.update') : translate('messages.add') . ' ' . translate('messages.new') }}
                    {{ translate('messages.sub_category') }}</h5>
            ...
            <div class="card-body">
                ...
                <form
                    ...
                    @endif
                    <div class="form-group">
                        <label class="input-label" for="exampleFormControlSelect1">{{ translate('messages.main') }}
        ...
        <div class="card mt-2">
            <div class="card-header pb-0">
                <h5 class="col">{{ translate('messages.sub_category') }} {{ translate('messages.list') }}<span
                ...
                <div class="col">
                    <select name="module_id" class="form-control js-select2-custom"
                        ...
                        <option value="" {{ !request('module_id') ? 'selected' : '' }}>
                            ...
                            {{ translate('messages.categories') }}</option>
                ...
                <form id="dataSearch">
                    ...
                    <div class="input-group input-group-merge input-group-flush">
                        ...
                        <input id="datatableSearch" name="search" type="search" class="form-control"
                            placeholder="{{ translate('messages.search_sub_categories') }}"
                                ...
                                <tr class="table_row" data-id="{{ $category->id }}">
                                    ...
                                    <td>
                                        <span class="d-block font-size-sm text-body">
                                            {{ Str::limit($category->parent['name'] ?? null, 20, '...') }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="d-block font-size-sm text-body">
