                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    placeholder="{{ translate('messages.new_zone') }}" value="{{ old('name') }}" required>
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">Sub Zone ddd
                                    {{ translate('messages.name') }}</label>
                                <input type="text" name="sub_zone" class="form-control"
                                    placeholder="{{ translate('messages.new_sub_zone') }}" value="{{ old('sub_zone') }}"
                                    required>
                            </div>
