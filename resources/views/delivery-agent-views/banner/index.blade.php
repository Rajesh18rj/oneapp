            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add') }}
                        {{ translate('messages.new') }} {{ translate('messages.banner') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.banner.store') }}" method="post" id="banner_form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="banner_type" class="form-control"
                                            ...
                                            <option value="store_wise">{{ translate('messages.store') }}
                                                {{ translate('messages.wise') }}</option>
                                            <option value="item_wise">{{ translate('messages.item') }}
                                                {{ translate('messages.wise') }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group" id="store_wise">
                                        ...
                                        <select name="store_id" class="js-data-example-ajax form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ translate('messages.campaign') }}
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                <div class="card">
                    <div class="card-header">
                        <h5>{{ translate('messages.banner') }} {{ translate('messages.list') }}<span
                                class="badge badge-soft-dark ml-2" id="itemCount">{{ $banners->count() }}</span></h5>
                        <form id="search-form">
                            @csrf
                            <!-- Search -->
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <tbody id="set-rows">
                                @foreach ($banners as $key => $banner)
                                    <tr class="table_row" data-id="{{ $banner->id }}">
                                        <td>
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    onclick="location.href='{{ route('admin.banner.featured', [$banner['id'], $banner->featured ? 0 : 1]) }}'"
                                                    class="toggle-switch-input" id="featuredCheckbox{{ $banner->id }}"
                                        ...
                                        <td>
                                            <label class="toggle-switch toggle-switch-sm"
                                                ...
                                                <input type="checkbox"
                                                    ...
                                                    class="toggle-switch-input" id="statusCheckbox{{ $banner->id }}"
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-white"
                                                href="{{ route('admin.banner.edit', [$banner['id']]) }}"title="{{ translate('messages.edit') }} {{ translate('messages.banner') }}"><i
                                                    class="tio-edit"></i>
                                            </a>
            ...
            $('#bulkDelete').on('click', function() {
                ...
                if (itemIds.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: '{{ url('/') }}/admin/banner/bulk-item-delete',
                                type: 'DELETE',
                                data: {
                                    item_ids: itemIds,
                                    "_token": "{{ csrf_token() }}"
