...
<head>
    ...
    <!-- Title -->
    <title>{{ translate('messages.delivery_agent') }} | {{ translate('messages.login') }}</title>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <!-- Form -->
                            <form class="" action="{{ route('delivery-agent.auth.login') }}" method="post"
                                id="form-id">
                                @csrf
                                <div class="text-center">
                                    <div class="mb-5">
                                        ...
                                        <span class="badge badge-soft-info">(
                                            {{ translate('messages.delivery_agent_signin') }} )</span>
