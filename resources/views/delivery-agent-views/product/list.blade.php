        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm-4 col-12">
                    <h1 class="page-header-title"> {{ translate('messages.item') }} {{ translate('messages.list') }}<span
                            class="badge badge-soft-dark ml-2" id="foodCount">{{ $items->total() }}</span></h1>
                </div>
                ...
                <div class="col-sm-4 col-6">
                    <select name="store_id" id="store" onchange="set_store_filter('{{ url()->full() }}',this.value)"
                        data-placeholder="{{ translate('messages.select') }} {{ translate('messages.store') }}"
                        class="js-data-example-ajax form-control"
                        onchange="getStoreData('{{ url('/') }}/admin/vendor/get-addons?data[]=0&store_id=',this.value,'add_on')"
                        required title="Select Store"
                            ...
                            <div class="col-auto">
                                ...
                                <div class="hs-unfold mr-2" style="width: 306px;">
                                    <select name="category_id" id="category"
                                        ...
                                        @else
                                            <option value="all" selected>{{ translate('messages.all_categories') }}
                                            </option>
                                        @endif
                                    </select>
                                </div>
            ...
            $('#bulkDelete').on('click', function() {
                ...
                if (itemIds.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: '{{ url('/') }}/admin/item/bulk-item-delete',
                                type: 'DELETE',
                                data: {
                                    item_ids: itemIds,
                                    "_token": "{{ csrf_token() }}"
