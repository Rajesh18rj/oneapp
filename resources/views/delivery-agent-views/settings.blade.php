...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{route('delivery-agent.dashboard')}}">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{env('APP_MODE')!='demo'?route('delivery-agent.settings'):'javascript:'}}" method="post" enctype="multipart/form-data" id="admin-settings-form">
                @csrf
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="{{asset('storage/app/public/delivery-man')}}/{{auth('delivery_men')->user()->image}}"
                                 alt="Image">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-sm-down-break">
                                        <input type="text" class="form-control" name="f_name" id="firstNameLabel"
                                               ...
                                               value="{{auth('delivery_men')->user()->f_name}}">
                                        <input type="text" class="form-control" name="l_name" id="lastNameLabel"
                                               ...
                                               value="{{auth('delivery_men')->user()->l_name}}">
                                    </div>
                                </div>
                            </div>
                            <!-- End Form Group -->
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           ...
                                           value="{{auth('delivery_men')->user()->phone}}"
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" class="form-control" name="email" id="newEmailLabel"
                                           value="{{auth('delivery_men')->user()->email}}"
                                           placeholder="{{translate('messages.enter_new_email_address')}}" aria-label="{{translate('messages.enter_new_email_address')}}">
                                </div>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('admin-settings-form','Want to update profile info ?')":"call_demo()"}}" class="btn btn-primary">{{translate('messages.save')}}</button>
                            </div>
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{env('APP_MODE')!='demo'?route('delivery-agent.settings-password'):'javascript:'}}" method="post"
                        ...
                        <!-- Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm','".translate('messages.want_to_update_password')."')":"call_demo()"}}" class="btn btn-primary">{{translate('messages.save')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
