        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{ translate('messages.deliveryman') }}
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th style="width: 25%">{{ translate('messages.customer') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="d-block font-size-sm text-body">
                                                    <a
                                                        href="{{ route('delivery-agent.delivery-man.preview', [$review['delivery_man_id']]) }}">
                                            ...
                                            <td>
                                                @if ($review->customer)
                                                    <a href="{{ route('delivery-agent.customer.view', [$review->user_id]) }}">
                                            ...
                                            <td>
                                                ...
                                                <form
                                                    action="{{ route('delivery-agent.delivery-man.reviews.status', [$review['id'], $review->status ? 0 : 1]) }}"
