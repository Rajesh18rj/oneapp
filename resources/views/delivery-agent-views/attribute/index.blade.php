            ...
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-add-circle-outlined"></i> {{ translate('messages.add') }}
                        {{ translate('messages.new') }} {{ translate('messages.attribute') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control"
                                    placeholder="{{ translate('messages.new_attribute') }}" maxlength="191" required>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{ translate('messages.attribute') }} {{ translate('messages.list') }}<span
                                class="badge badge-soft-dark ml-2" id="itemCount">{{ $attributes->total() }}</span></h5>
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            <tbody id="set-rows">
                                @foreach ($attributes as $key => $attribute)
                                    <tr class="table_row" data-id="{{ $attribute->id }}">
                                        <td>
            ...
            $('#bulkDelete').on('click', function() {
                ...
                if (itemIds.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: '{{ url('/') }}/admin/attribute/bulk-item-delete',
                                type: 'DELETE',
                                data: {
                                    item_ids: itemIds,
                                    "_token": "{{ csrf_token() }}"
