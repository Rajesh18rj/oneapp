...
<body>
                    ...
                    @if ($toggle_store_registration)
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('restaurant.create') }}">
                                {{ translate('messages.store_Signup') }}
                            </a>
                        </li>
                    @endif
                    @if ($toggle_dm_registration)
                        <li class="nav-item"><a class="nav-link"
                                href="{{ route('deliveryman.create') }}">{{ translate('messages.courier_Signup') }}</a>
                        </li>
                    @endif
                    <li class="nav-item">
                        <a class="nav-link"
            ...
            @else
                col-md-3 @endif footer-col">
                    ...
                    <ul class="list-unstyled text-muted">
                        ...
                        <li>
                            <a href="{{ route('reader-policy') }}">{{ translate('messages.reader-policy') }}</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="cookie-notice"><span class="cookie">🍪</span>
        <p>We are using Cookies! For more information visit this page&nbsp;<a href="#">Cookie policy</a>.</p>
