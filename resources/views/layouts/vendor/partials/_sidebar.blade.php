                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if(\App\CentralLogics\Helpers::employee_module_permission_check('deliveryman'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('vendor-panel/delivery-man/add')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                 href="{{ route('vendor.delivery-man.add', ['type' => 'individual']) }}"
                        ...
                        <li class="navbar-vertical-aside-has-menu d-none {{Request::is('vendor-panel/sub-zones')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                               href="{{route('vendor.sub-zones')}}"
                               title="Sub Zones">
                                <i class="tio-running nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    Sub Zones
