        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content" style="background-color: #213A36;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check(['module', 'pos']))
                        <li class="nav-item">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ translate('messages.add') }} {{ translate('messages.module') }}">
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        ...
                                        title="{{ translate('messages.models') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('order'))
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu d-none {{ Request::is('admin/user-reviews/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.user_reviews.list') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check(['parcel']))
                        <!-- Parcel Section -->
                        <li class="nav-item">
                            <small class="nav-subtitle"
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check(['zone', 'store']))
                        <!-- Restaurant -->
                        <li class="nav-item">
                            <small class="nav-subtitle"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('zone'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/zone*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.zone.home') }}" title="{{ translate('messages.zone') }}">
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check(['category', 'attribute', 'unit', 'item', 'addon']))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('unit'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/unit*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.unit.index') }}" title="{{ translate('messages.unit') }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('deliveryman'))
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.delivery-man.add', ['type' => 'individual']) }}"
                        ...
                        <li
                         ...
                         @endif
                        @if (\App\CentralLogics\Helpers::module_permission_check('delivery_agent'))
                        
                         <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-man/add/agent') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('admin.delivery-man.add', ['type' => 'agent']) }}"
                             
                                title="{{ translate('messages.add_Delivery_agent') }}">
                                <i class="tio-running nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{ translate('messages.add_Delivery_Agent') }}
                                </span>
                            </a>
                        </li>
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-man/agent-list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.delivery-man.agent-list') }}" title="Delivery Agent">
                                <i class="tio-filter-list nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    Delivery Agent
                                </span>
                        ...
                        <li
                         ...
                         @if (\App\CentralLogics\Helpers::module_permission_check('vehicle_type'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/vehicle-type*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.vehicle_type') }}">
                                <i class="tio-bus nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Vehicle
                                    Type</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/vehicle_type*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/vehicle_type/add-new') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.vehicle_type.add-new') }}"
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/vehicle_type/list*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.vehicle_type.list') }}"
                                        title="{{ translate('messages.vehicle_type') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            List
                         ...
                         @if (\App\CentralLogics\Helpers::module_permission_check('logistic_type'))
                              <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/logistic-type*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.logisitic_type') }}">
                                <i class="tio-bus nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Logistic
                                    Type</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/logistic-type*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/logistic-type/add-new') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.logistic_type.add-new') }}"
                                        title="{{ translate('messages.add_new') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            Add New
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/logistic-type/list*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.logistic_type.list') }}"
                                        title="{{ translate('messages.logistic_type') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            List
                                        </span>
                    ...
                    @endif
                      @if (\App\CentralLogics\Helpers::module_permission_check('commodity_type'))
                    
                     <li
                            class="navbar-vertical-aside-has-menu  {{ Request::is('admin/commodity-type*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.commodity_type') }}">
                                <i class="tio-bus nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Commodity
                                    Type</span>
                            </a>
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{ Request::is('admin/commodity-type*') ? 'block' : 'none' }}">
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/commodity-type/add-new') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.commodity_type.add-new') }}"
                                        title="{{ translate('messages.add_new') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            Add New
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu {{ Request::is('admin/commodity-type/list*') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('admin.commodity_type.list') }}"
                                        title="{{ translate('messages.commodity_type') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            List
                    ...
                    @if (
                        \App\CentralLogics\Helpers::modules_permission_check([
                            'campaign',
                            'banner',
                            'coupon',
                            'notification',
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('admin.currency.add-new') }}"
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('admin.business-settings.recycling-policy') }}"
                    ...
                    <!-- Reviews -->
                     ...
                     @if (\App\CentralLogics\Helpers::modules_permission_check(['custom_role', 'reviews']))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.employee_handle') }}">{{ translate('messages.reviews') }}
                                {{ translate('section') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf

                    @if (\App\CentralLogics\Helpers::module_permission_check('reviews'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/review*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.review.list') }}"
                                title="{{ translate('messages.reviews') }} ">
                                <i class="tio-incognito nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.reviews') }}
                                   </span>
                            </a>
                        </li>
                    @endif
