    ...
    <header id="header"
        ...
        <div class="navbar-nav-wrap">
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="{{route('delivery-agent.dashboard')}}" aria-label="">
            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    ...
                    {{--<li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('delivery-agent.message.list')}}">
                    ...
                    <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="hs-unfold">
                            <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
                               href="{{route('delivery-agent.order.list',['status'=>'pending'])}}">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="hs-unfold">
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-item-text">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <span class="card-title h5">{{auth('delivery_men')->user()->f_name}}</span>
                                            <span class="card-text">{{auth('delivery_men')->user()->email}}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a class="dropdown-item" href="{{route('delivery-agent.settings')}}">
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    if (result.value) {
                                    location.href='{{route('delivery-agent.auth.logout')}}';
                                    } else{
