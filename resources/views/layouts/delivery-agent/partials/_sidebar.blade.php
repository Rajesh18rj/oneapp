    ...
    <aside
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{ route('delivery-agent.dashboard') }}" aria-label="Front">
            ...
            <div class="navbar-vertical-content" style="background-color: #213A36;">
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('admin') ? 'show' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('delivery-agent.dashboard') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent(['module', 'pos']))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.module') }} {{ translate('messages.section') }}">{{ translate('messages.module') }}
                                {{ translate('messages.management') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf

                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('module'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/module*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"   href="{{ route('delivery-agent.module.index') }}"
                                title="{{ translate('messages.module') }}">
                                <i class="tio-globe nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.module') }}</span>
                            </a>
                          
                        </li>
                    @endif

                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('pos'))
                        <li class="nav-item">
                            <small class="nav-subtitle">{{ translate('messages.pos') }}
                                {{ translate('messages.system') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/pos/*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/pos/') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.pos.index') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/pos/orders') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.pos.orders') }}"
                    ...
                    @endif
                    <!-- Orders -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('order'))
                        <li class="nav-item">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/order*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.order') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/pending') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['pending']) }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/accepted') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['accepted']) }}"
                                        title="{{ translate('messages.acceptedbyDM') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/processing') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['processing']) }}"
                                        title="{{ translate('messages.preparingInRestaurants') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li
                                    ...
                                    <a class="nav-link text-capitalize"
                                        href="{{ route('delivery-agent.order.list', ['item_on_the_way']) }}"
                                        title="{{ translate('messages.itemOnTheWay') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/delivered') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['delivered']) }}"
                                        title="{{ translate('messages.delivered') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/canceled') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['canceled']) }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/failed') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['failed']) }}"
                                        title="{{ translate('messages.payment') }} {{ translate('messages.failed') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/refunded') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.order.list', ['refunded']) }}"
                                        title="{{ translate('messages.refunded') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/scheduled') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('delivery-agent.order.list', ['scheduled']) }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/order/list/all') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('delivery-agent.order.list', ['all']) }}"
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('delivery-agent.dispatch.list', ['searching_for_deliverymen']) }}"
                                ...
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('delivery-agent.dispatch.list', ['on_going']) }}"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/user-reviews/list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.user_reviews.list') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent(['parcel']))
                        <!-- Parcel Section -->
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.parcel') }} {{ translate('messages.section') }}">{{ translate('messages.parcel') }}
                                {{ translate('messages.section') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf

                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('parcel'))
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('delivery-agent.parcel.category.index') }}"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('delivery-agent.parcel.orders') }}"
                                        title="{{ translate('messages.parcel') }} {{ translate('messages.orders') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('delivery-agent.parcel.settings') }}"
                                        title="{{ translate('messages.parcel') }} {{ translate('messages.settings') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent(['zone', 'store']))
                        <!-- Restaurant -->
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.store') }} {{ translate('messages.section') }}">{{ translate('messages.store') }}
                                {{ translate('messages.management') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf

                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('zone'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/zone*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.zone.home') }}" title="{{ translate('messages.zone') }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('store'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/vendor*') && !Request::is('admin/vendor/withdraw_list') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.store') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('delivery-agent.vendor.add') }}"
                                        title="{{ translate('messages.register') }} {{ translate('messages.store') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                ...
                                <li class="navbar-item {{ Request::is('admin/vendor/list') ? 'active' : '' }}">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                                        href="{{ route('delivery-agent.vendor.list') }}"
                                        title="{{ translate('messages.store') }} {{ translate('messages.list') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.stores') }}
                                            {{ translate('list') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/vendor/bulk-import') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.vendor.bulk-import') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/vendor/bulk-export') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.vendor.bulk-export-index') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent(['category', 'attribute', 'unit', 'item', 'addon']))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.item') }} {{ translate('messages.section') }}">{{ translate('messages.item') }}
                                {{ translate('messages.management') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf
                    ...
                    <!-- Category -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('category'))
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/category/add') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.category.add') }}"
                                        title="{{ translate('messages.category') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('delivery-agent.category.add-sub-category') }}"
                                ...
                                {{-- <li class="nav-item {{Request::is('admin/category/add-sub-sub-category')?'active':''}}">
                                    <a class="nav-link " href="{{route('delivery-agent.category.add-sub-sub-category')}}"
                                ...
                                <li class="nav-item {{ Request::is('admin/category/bulk-import') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.category.bulk-import') }}"
                                        title="{{ translate('messages.bulk_import') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                                ...
                                <li class="nav-item {{ Request::is('admin/category/bulk-export') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.category.bulk-export-index') }}"
                                        title="{{ translate('messages.bukl_export') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_export') }}</span>
                    ...
                    <!-- Attributes -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('attribute'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/attribute*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.attribute.add-new') }}"
                    ...
                    <!-- Unit -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('unit'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/unit*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.unit.index') }}" title="{{ translate('messages.unit') }}">
                    ...
                    <!-- AddOn -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('addon'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/addon/add-new') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.addon.add-new') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/addon/bulk-import') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.addon.bulk-import') }}"
                                        title="{{ translate('messages.bulk_import') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                                ...
                                <li class="nav-item {{ Request::is('admin/addon/bulk-export') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.addon.bulk-export-index') }}"
                                        title="{{ translate('messages.bukl_export') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_export') }}</span>
                    ...
                    <!-- End AddOn -->
                    <!-- Food -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('item'))
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/item*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.item') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/item/add-new') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.item.add-new') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/item/list') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.item.list') }}"
                                        title="{{ translate('messages.item') }} {{ translate('messages.list') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('messages.list') }}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::is('admin/item/reviews') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.item.reviews') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/item/bulk-import') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.item.bulk-import') }}"
                                        title="{{ translate('messages.bulk_import') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_import') }}</span>
                                ...
                                <li class="nav-item {{ Request::is('admin/item/bulk-export') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.item.bulk-export-index') }}"
                                        title="{{ translate('messages.bukl_export') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate text-capitalize">{{ translate('messages.bulk_export') }}</span>
                    ...
                    <!-- End Food -->
                    <!-- DeliveryMan -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('deliveryman'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/delivery-man/add/individual') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('delivery-agent.delivery-man.add', ['type' => 'individual']) }}"
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.delivery-man.list') }}"
                    ...
                    <!-- Customer Section -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('customerList'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.customer.list') }}"
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.customer.subscribed') }}" title="Subscribed emails">
                    ...
                    @if (
                        \App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent([
                            'campaign',
                            'banner',
                            'coupon',
                            'notification',
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.employee_handle') }}">{{ translate('messages.marketing') }}
                                {{ translate('messages.section') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endif
                    <!-- Campaign -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('campaign'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/campaign*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                title="{{ translate('messages.campaign') }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/campaign/basic/*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.campaign.list', 'basic') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/campaign/item/*') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.campaign.list', 'item') }}"
                                        title="{{ translate('messages.item') }} {{ translate('messages.campaign') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                    ...
                    <!-- End Campaign -->
                    <!-- Banner -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('banner'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/banner*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.banner.add-new') }}"
                    ...
                    <!-- End Banner -->
                    <!-- Coupon -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('coupon'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/coupon*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.coupon.add-new') }}"
                                title="{{ translate('messages.coupon') }}">
                    ...
                    <!-- End Coupon -->
                    <!-- Notification -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('notification'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/notification*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.notification.add-new') }}"
                                title="{{ translate('messages.send') }} {{ translate('messages.notification') }}">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('withdraw_list'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.business') }} {{ translate('messages.section') }}">{{ translate('messages.business') }}
                                {{ translate('messages.section') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                    @endIf
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('withdraw_list'))
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.vendor.withdraw_list') }}"
                                title="{{ translate('messages.store') }} {{ translate('messages.withdraws') }}">
                                <i class="tio-table nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('messages.store') }}
                    ...
                    <!-- End withdraw -->
                    <!-- account -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('account'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/account-transaction*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.account-transaction.index') }}"
                    ...
                    <!-- provide_dm_earning -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('provide_dm_earning'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/provide-deliveryman-earnings*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.provide-deliveryman-earnings.index') }}"
                    ...
                    <!-- Business Settings -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('settings'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.business-setup') }}"
                        ...
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/currency*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('delivery-agent.currency.add-new') }}"
                                title="{{ translate('messages.currency') }} {{ translate('messages.setup') }}">
                                <span class="tio-money nav-icon"></span>
                                <span class="text-truncate">{{ translate('messages.currency') }}
                                    {{ translate('messages.setup') }}</span>
                            </a>
                        </li>
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.social-media.index') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.payment-method') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.mail-config') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.sms-module') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.fcm-index') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('settings'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                title="{{ translate('messages.business') }} {{ translate('messages.settings') }}">{{ translate('messages.web_and_app') }}
                                {{ translate('messages.settings') }}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/app-settings*') ? 'active' : '' }}">
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.app-settings') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link "
                                href="{{ route('delivery-agent.business-settings.landing-page-settings', 'index') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.config-setup') }}"
                        ...
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('delivery-agent.business-settings.terms-and-conditions') }}"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('delivery-agent.business-settings.privacy-policy') }}"
                                ...
                                <li
                                    ...
                                    <a class="nav-link "
                                        href="{{ route('delivery-agent.business-settings.shipping-policy') }}"
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/business-settings/pages/return-policy') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.business-settings.return-policy') }}"
                                        title="{{ translate('messages.return_policy') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                ...
                                <li
                                    class="nav-item {{ Request::is('admin/business-settings/pages/recycling-policy') ? 'active' : '' }}">
                                    <a class="nav-link "
                                        href="{{ route('delivery-agent.business-settings.recycling-policy') }}"
                                        title="{{ translate('messages.recycling_policy') }}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{ translate('Recycling Policy') }}</span>
                                    </a>
                                </li>
                                ...
                                <li
                                    ...
                                    <a class="nav-link " href="{{ route('delivery-agent.business-settings.about-us') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.file-manager.index') }}"
                                title="{{ translate('messages.third_party_apis') }}">
                        ...
                        {{-- <li class="navbar-vertical-aside-has-menu {{Request::is('admin/social-login/view')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{route('delivery-agent.social-login.view')}}">
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.business-settings.recaptcha_index') }}"
                        ...
                        <li
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.business-settings.db-index') }}">
                    ...
                    <!-- Report -->
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('report'))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.report.day-wise-report') }}"
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.report.item-wise-report') }}"
                                title="{{ translate('messages.item_wise_report') }}">
                        ...
                        <li
                            ...
                            <a class="nav-link " href="{{ route('delivery-agent.report.stock-report') }}"
                                title="{{ translate('messages.stock_report') }}">
                                <span class="tio-chart-bar-4 nav-icon"></span>
                                <span
                                    class="text-truncate text-capitalize">{{ translate('messages.stock_report') }}</span>
                            </a>
                        </li>
                    @endif
                    ...
                    @if (\App\CentralLogics\Helpers::modules_permission_check_for_delivery_agent(['custom_role', 'employee']))
                        <li class="nav-item">
                            <small class="nav-subtitle"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('custom_role'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/custom-role*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('delivery-agent.custom-role.create') }}"
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('employee'))
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{ Request::is('admin/employee/add-new') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.employee.add-new') }}"
                                ...
                                <li class="nav-item {{ Request::is('admin/employee/list') ? 'active' : '' }}">
                                    <a class="nav-link " href="{{ route('delivery-agent.employee.list') }}"
