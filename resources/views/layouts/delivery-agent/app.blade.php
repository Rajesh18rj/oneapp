...
<!-- Builder -->
@include('layouts.delivery-agent.partials._front-settings')
<!-- End Builder -->

<!-- JS Preview mode only -->
@include('layouts.delivery-agent.partials._header')
@include('layouts.delivery-agent.partials._sidebar')
<!-- END ONLY DEV -->
...
<!-- End Content -->
    ...
    <!-- Footer -->
@include('layouts.delivery-agent.partials._footer')
<!-- End Footer -->
...
<script>
    ...
    @if(\App\CentralLogics\Helpers::module_permission_check_for_delivery_agent('order'))
        ...
        function check_order() {
            ...
            {
                location.href = "{{route('delivery-agent.parcel.orders')}}";
            }
            else
            {
                location.href = "{{route('delivery-agent.order.list',['status'=>'all'])}}";
            }
