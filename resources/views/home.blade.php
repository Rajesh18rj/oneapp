...
@section('content')
            ...
            <div class="row hero-content-main">
                    ...
                    <div class="app-logo animate__animated animate__fadeInDown">
                        ...
                        @if ($landing_page_links['app_url_ios_status'])
                            <a href="{{ $landing_page_links['app_url_ios'] }}">
                                <img class="img-fluid" src="{{ asset('public/assets/landing') }}/image/apple_store.png"
                                    alt="iOS App">
                            </a>
                        @endif
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <img src="{{ asset('public/assets/landing') }}/image/{{ isset($landing_page_images['top_content_image']) ? $landing_page_images['top_content_image'] : 'double_screen_image.png' }}"
                        ...
                        alt="Image One" class="img-fluid hero-content-image animate__animated animate__bounceInRight" />
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 about-us-left">
                        <img class="img-fluid stuning-image w-100"
                            src="{{ asset('public/assets/landing') }}/image/{{ isset($landing_page_images['feature_section_image']) ? $landing_page_images['feature_section_image'] : 'about_us_image.png' }}"
                            alt="About us" />
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 about-us-left">
                        <img class="img-fluid our-app-image w-100"
                            src="{{ asset('public/assets/landing') }}/image/{{ isset($landing_page_images['mobile_app_section_image']) ? $landing_page_images['mobile_app_section_image'] : 'our_app_image.png' }}"
                            alt="Image" />
                    </div>
                        ...
                        @foreach ($testimonial as $data)
                            <div class="col owl-item">
                                <div class="testimonial">
                                    <div class="pic">
                                        <img class="img-fluid"
                                            src="{{ asset('public/assets/landing') }}/image/{{ $data['img'] }}"
                                            alt="Image">
                                    </div>
    ...
    <section class="customer-testimonial">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center text-center">
                <div class="owl-carousel mt-4">
                    @foreach (\App\Models\UserReview::where('status', 'approved')->get() as $review)
                                    ...
                                    <div class="pic">
                                        @if ($review->reviewable_type == 'App\Models\Vendor')
                                            <img width="60" style="border-radius: 50%; height:100%;"
                                                ...
                                                src="{{ asset('storage/app/public/store') }}/{{ $review->reviewable->stores[0]->logo }}"></a>
                                        @elseif ($review->reviewable_type == 'App\Models\User')
                                            <img class="avatar-img"
                                                onerror="this.src='{{ asset('public/assets/admin/img/160x160/img1.jpg') }}'"
                                                src="{{ asset('storage/app/public/profile/' . $review->reviewable->image) }}"
