                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-5">
                                <h1 class="display-4">{{translate('messages.store')}} {{translate('messages.sign_in')}}</h1>
                        ...
                        <form class="login_form" action="{{route('vendor.auth.login')}}" method="post" id="vendor_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{translate('messages.store_owner_login_form')}}</span>
                                </div>
                            </div>
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password" id="signupSrPassword" placeholder="9+ characters required"
                                           aria-label="9+ characters required" required
                        ...
                        <form class="login_form" action="{{route('vendor.auth.employee.login')}}" method="post" id="employee_login_form" style="display: none;">
                            ...
                            <div class="text-center">
                                <div class="m-2">
                                    <span class="divider text-muted m-4">{{{translate('messages.store_employee_login_form')}}}</span>
                                </div>
                            </div>
                            <!-- Form Group -->
                            <div class="js-form-message form-group">
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="js-toggle-password form-control form-control-lg"
                                           name="password"  placeholder="{{translate('messages.password_length_placeholder', ['length'=>'9+'])}}"
                                           aria-label="9+ characters required" required
                                           data-msg="{{translate('messages.invalid_password_warning')}}"
                                           data-hs-toggle-password-options='{
