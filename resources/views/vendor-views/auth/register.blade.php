        ...
        <div class="container">
            ...
            <div class="row">
                <div class="card shadow-sm col-12">
                    <form class="card-body" action="{{ route('restaurant.store') }}" method="post"
                        ...
                        <div class="row row-margin-top">
                            <div class="col-md-6 col-lg-6 col-sm-12 float-end">
                                <div class="form-group">
                                    ...
                                    <label for="name" class="pt-2">{{ translate('messages.upload') }}
                                        {{ translate('messages.cover') }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="longitude" class="form-control"
                                        placeholder="Ex : 103.344322" id="longitude" value="{{ old('longitude') }}"
                                        required readonly>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4 col-lg-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control"
                                        placeholder="Ex : 017********" value="{{ old('phone') }}" required>
                                </div>
