    ...
    <div class="content container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{ translate('messages.employee_form') }}</li>
            </ol>
        </nav>
        <!-- Page Heading -->
                    ...
                    <div class="card-body">
                        <form action="{{ route('vendor.employee.add-new') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label class="input-label qcont" for="fname">{{ translate('messages.first') }}
                                    ...
                                    <div class="col-md-6">
                                        <label class="input-label qcont" for="lname">{{ translate('messages.last') }}
                                            {{ translate('messages.name') }}</label>
                                        <input type="text" name="l_name" class="form-control" id="lname"
                                            value="{{ old('l_name') }}" placeholder="Ex : Prodhan"
                                            value="{{ old('name') }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" name="phone" value="{{ old('phone') }}"
                                            class="form-control" id="phone" placeholder="Ex : +88017********" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="input-label qcont"
                                            for="role_id">{{ translate('messages.Role') }}</label>
                                        <select class="form-control custom-select2" name="role_id" style="width: 100%"
                                            required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" name="email" value="{{ old('email') }}"
                                            class="form-control" id="email" placeholder="Ex : ex@gmail.com" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="input-label qcont"
                                            for="password">{{ translate('messages.password') }}</label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="input-label qcont"
                                            for="customFileUpload">{{ translate('messages.employee_image') }}</label>
                                        <div class="form-group">
