...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-md-flex_ align-items-center justify-content-between mb-2">
            <div class="row">
                <div class="col-md-8">
                    <h3 class="h3 mb-0 text-black-50">{{ translate('messages.Employee') }}
                        {{ translate('messages.list') }}<span class="badge badge-soft-dark ml-2"
                            id="itemCount">{{ $em->total() }}</span></h3>
                </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header py-0">
                        <h5>{{ translate('messages.Employee') }} {{ translate('messages.table') }}</h5>
            ...
            $('#bulkDelete').on('click', function() {
                ...
                if (itemIds.length > 0) {
                    ...
                    Swal.fire({
                        ...
                        if (result.value) {
                            $.ajax({
                                url: '{{ url('/') }}/vendor-panel/employee/bulk-item-delete',
                                type: 'DELETE',
                                data: {
                                    item_ids: itemIds,
                                    "_token": "{{ csrf_token() }}"
