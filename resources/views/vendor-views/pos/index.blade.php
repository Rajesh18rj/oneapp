				...
				<div class="col-md-8 card padding-y-sm card ">
                    <div class="card-header d-flex flex-wrap justify-content-between ">
                     ...
                     <ul class="product_views">
                      <li class="active grid_view_type" onclick="switchView('grid')">Grid View</li>
                      <li class="list_view_type" onclick="switchView('list')">List View</li>
                    </ul>
		  <div class="card-body" id="items">
                        <div class="d-flex flex-wrap mt-2 mb-3" id="grid-view" style="justify-content: space-around;">
                        ...
                        <div class="d-none flex-wrap mt-2 mb-3" id="list-view" style="justify-content: space-around;">
                           <div class="table-responsive datatable-custom" id="table-div" style="margin-top:20px;">

    <div id="datatable_wrapper" class="dataTables_wrapper no-footer"><table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table dataTable no-footer" data-hs-datatables-options="" style="margin-top:20px;" role="grid" aria-describedby="datatable_info">
               <thead class="thead-light">
  <tr role="row">
	        <th style="width: 175.328px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Image</th>
    <th style="width: 175.328px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Name</th>

    <th style="width: 112.078px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">HSN</th>

    <th style="width: 81.125px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Category</th>
    <th style="width: 72.047px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">SAC</th>
    <th style="width: 139.359px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Store</th>
    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 56.25px;">Price</th>
    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"  style="width: 41.2812px;">GST</th>
    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 125.438px;">Batch number</th>
    <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"aria-label="Expiry date: activate to sort column ascending" style="width: 92.484px;">Expiry date</th>
    <th style="width: 175.328px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Description</th>
    <th style="width: 175.328px;" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">System Module</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Discount Type</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Discount</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Unit</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Item Type</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Sub Category</th>

    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Total Stock</th>

    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Available time starts</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Available time ends</th>
    <th style="" class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1">Youtube Video URL</th>
  </tr>
</thead>
        <tbody id="set-rows">
                            @foreach($products as $product)
                                   
                                    @include('admin-views.pos._single_product_list_view',['product'=>$product, 'restaurant_data'=>$store_data])
                                    {{--<hr class="d-sm-none">--}}
...
<script>
    ...
    function updateCart() {
     ...
     function switchView(type){
      if(type == "grid"){
        $(".grid_view_type").addClass("active");
        $(".list_view_type").removeClass("active");
      	$("#grid-view").removeClass("d-none");
      	$("#grid-view").addClass("d-flex");
      	$("#list-view").removeClass("d-flex");
      	$("#list-view").addClass("d-none");
      } else {

        $(".grid_view_type").removeClass("active");
        $(".list_view_type").addClass("active");
        $("#grid-view").removeClass("d-flex");
      	$("#grid-view").addClass("d-none");
      	$("#list-view").removeClass("d-none");
      	$("#list-view").addClass("d-flex");
      }
    }
