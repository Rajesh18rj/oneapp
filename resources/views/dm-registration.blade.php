                            ...
                            <div class="col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="input-label"
                                        ...
                                        style="color:red;font-size:18px;display:none;" id="vehicle_plate_number_required_section"><strong>*</strong></span>
                            ...
                            <div class="row d-flex" id="initial-deposit-section">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <label
                                            class="input-label">{{ translate('messages.Initial_Deposit_Receipt') }}</label><span
                                        style="color:red;font-size:18px;"><strong>*</strong>
                                        <div class="custom-file">
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group mb-12">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm" for="toggleColumn_index"><span
                                            style="color:red;font-size:18px;"></span>
                                        <input type="radio" class="toggle-switch-input ppe" id="ppe"
                                            name="ppe" value="1">
                                    ...
                                    <label class="toggle-switch toggle-switch-sm" for="toggleColumn_index"><span
                                            style="color:red;font-size:18px;"></span>
                                        <input type="radio" class="toggle-switch-input ppe"
