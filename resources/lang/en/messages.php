<?php return array (
  ...
  'Recycling Policy Updated' => 'Recycling Policy Updated',
  'Return Policy Updated' => 'Return Policy Updated',
  'Shipping Policy Updated' => 'Shipping Policy Updated',
  ...
  'Runnable solutions are disabled in non-local environments. Please make sure `APP_ENV` is set correctly. Additionally please make sure `APP_DEBUG` is set to false on ANY production environment!' => 'Runnable solutions are disabled in non-local environments. Please make sure `APP ENV` is set correctly. Additionally please make sure `APP DEBUG` is set to false on ANY production environment!',
  'Forbidden' => 'Forbidden',
  ...
  'Icon and thumnail should not be allowed to upload same image. ' => 'Icon and thumnail should not be allowed to upload same image. ',
  'Icon and thumbnail should not be allowed to upload the same image.' => 'Icon and thumbnail should not be allowed to upload the same image.',
  'sub_zone' => 'Sub zone',
  'new_sub_zone' => 'New sub zone',
  'sub_zone_distance' => 'Sub zone distance',
  'courier_registration' => 'Courier registration',
  'courier_application' => 'Courier application',
  ...
  'store_signup' => 'Store signup',
  'courier_signup' => 'Courier signup',
  'courier_Signup' => 'Courier Signup',
  'store_Signup' => 'Store Signup',
  'about_Us' => 'About Us',
  'User' => 'User',
  ...
  'CIN' => 'CIN',
  'Image' => 'Image',
  'Channel_Partner_Commission' => 'Channel Partner Commission',
  'default_channel_partner_commission' => 'Default channel partner commission',
  'default_delivery_man_commission' => 'Default delivery man commission',
  'Passbook' => 'Passbook',
  'Deposit' => 'Deposit',
  'Delivery_man' => 'Delivery man',
  'delivery_man_deposit_amount' => 'Delivery man deposit amount',
  'GST' => 'GST',
  'Payment' => 'Payment',
  'Initial_Deposit_Receipt' => 'Initial Deposit Receipt',
  ...
  'ifsc_code' => 'Ifsc code',
  'logistic' => 'Logistic',
  'add_new_logistic_type' => 'Add new logistic type',
  'logsitic_Type' => 'Logsitic Type',
  'Logistic' => 'Logistic',
  'edit_logistic_type' => 'Edit logistic type',
  'logistic_type_updated_successfully' => 'Logistic type updated successfully',
  'logistic_type_added_successfully' => 'Logistic type added successfully',
  'mail_received_successfully' => 'Mail received successfully',
  'Want_to_delete_this_logistic_type' => 'Want to delete this logistic type',
  'Want_to_delete_this_logistic_type?' => 'Want to delete this logistic type ',
  'logistic_type_deleted_successfully' => 'Logistic type deleted successfully',
  'logistic type' => 'Logistic type',
  'commodity' => 'Commodity',
  'add_new_commodity_type' => 'Add new commodity type',
  'commodity_Type' => 'Commodity Type',
  'edit_commodity_type' => 'Edit commodity type',
  'commodity_type_updated_successfully' => 'Commodity type updated successfully',
  'commodity_type_added_successfully' => 'Commodity type added successfully',
  'Want_to_delete_this_commodity_type' => 'Want to delete this commodity type',
  'Want_to_delete_this_commodity_type?' => 'Want to delete this commodity type ',
  'commodity_type_deleted_successfully' => 'Commodity type deleted successfully',
  'commodity type' => 'Commodity type',
  'account_details' => 'Account details',
  'cookie' => 'Cookie',
  'is_gst_certificate_enabled' => 'Is gst certificate enabled',
  ...
  'CIN_Certificate' => 'CIN Certificate',
  'ABN_Certificate' => 'ABN Certificate',
  'TFN_Certificate' => 'TFN Certificate',
  'AN_Certificate' => 'AN Certificate',
  'ACN_Certificate' => 'ACN Certificate',
  'TFN' => 'TFN',
  ...
  'ACN' => 'ACN',
  'a' => 'A',
  'delivery_agent_signin' => 'Delivery agent signin',
  'Hello, here you can manage your delivery men by zone.' => 'Hello  here you can manage your delivery men by zone.',
  'admin_account' => 'Admin account',
  'account' => 'Account',
  'want_to_login_your_delivery_agent_account' => 'Want to login your delivery agent account',
  'Update Module' => 'Update Module',
  'Update System Module' => 'Update System Module',
  'reject' => 'Reject',
  'Reject' => 'Reject',
  'Approve' => 'Approve',
  ...
  'aDelivery_Agent' => 'ADelivery Agent',
  'Delivery_Agent' => 'Delivery Agent',
  'delivery agent' => 'Delivery agent',
  'already_approved' => 'Already approved',
  'Details saved successfully' => 'Details saved successfully',
  'delivery agent_preview' => 'Delivery agent preview',
  'delivery agent updated_successfully' => 'Delivery agent updated successfully',
  'deliverry' => 'Deliverry',
  'logistic_type' => 'Logistic type',
  'logisitic_type' => 'Logisitic type',
  'add_new' => 'Add new',
  'Reuest has been send to admin succesfully' => 'Reuest has been send to admin succesfully',
  'Request has been send to admin succesfully' => 'Request has been send to admin succesfully',
  'Request is already send to admin' => 'Request is already send to admin',
  'manage_module_request' => 'Manage module request',
  'Approve Employee Status' => 'Approve Employee Status',
  'Reject Employee Status' => 'Reject Employee Status',
  'manage_zone_request' => 'Manage zone request',
  'Manage Module Request' => 'Manage Module Request',
  'request is not sendt by admin' => 'Request is not sendt by admin',
  'Module request is not sent by admin' => 'Module request is not sent by admin',
  'Module request is approved' => 'Module request is approved',
  'Request is already approved by admin' => 'Request is already approved by admin',
  'Please select atleast one module id' => 'Please select atleast one module id',
  'Module request is not sent by delivery agent' => 'Module request is not sent by delivery agent',
  'Manage Zone Request' => 'Manage Zone Request',
  'Please select atleast one zone id' => 'Please select atleast one zone id',
  'Zone request is approved' => 'Zone request is approved',
  'sub_zone_name' => 'Sub zone name',
  'Zone request is not sent by delivery agent' => 'Zone request is not sent by delivery agent',
  'Vendor' => 'Vendor',
  'fssai_Certificate' => 'Fssai Certificate',
  'delivery_man_earnings' => 'Delivery man earnings',
  'delivery man updated_successfully' => 'Delivery man updated successfully',
  'you_want_to_reject_this_review' => 'You want to reject this review',
  'you_want_to_approve_this_review' => 'You want to approve this review',
  'review to' => 'Review to',
  'review from' => 'Review from',
  'Review approved successfully' => 'Review approved successfully',
  'Review rejected successfully' => 'Review rejected successfully',
  'admin_comissions' => 'Admin comissions',
  'admin_comission' => 'Admin comission',
  'Email Verification' => 'Email Verification',
  'Snacks and Chaats' => 'Snacks and Chaats',
  'Biriyani' => 'Biriyani',
  'pasbook_image' => 'Pasbook image',
  'bank_cheque' => 'Bank cheque',
  'Insurance field disabled successfully' => 'Insurance field disabled successfully',
  'Insurance field enabled successfully' => 'Insurance field enabled successfully',
  'No delivery man assigned to this order' => 'No delivery man assigned to this order',
  ...
  'Amount paid successfully' => 'Amount paid successfully',
