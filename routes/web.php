...
Route::get('recycling-policy', 'HomeController@recycling_policy')->name('recycling-policy');

Route::get('reader-policy', 'HomeController@reader_policy')->name('reader-policy');
...
Route::group(['prefix' => 'deliveryman', 'as' => 'deliveryman.'], function () {
    ...
    Route::post('send-verification-code', 'DeliveryManController@send_verification_code')->name('send-verification-code');
    Route::get('get-sub-zones', 'DeliveryManController@get_sub_zones')->name('get-sub-zones');
    Route::get('get-all-sub-zones', 'DeliveryManController@get_all_sub_zones')->name('get-all-sub-zones');
});
