...
Route::group(['namespace' => 'DeliveryAgent', 'as' => 'delivery-agent.'], function () {
    /*authentication*/
    ...
    Route::group(['middleware' => ['delivery-agent']], function () {
        ...
        Route::get('module/status/{id}/{status}', 'ModuleController@status')->middleware('module:module')->name('module.status');
         Route::get('module/send-assign-request/{id}/{status}', 'ModuleController@sendModuleAssignRequest')->middleware('module:module')->name('module.send-assign-request');
         
	Route::delete('module/bulk-send-assign-module-request', 'ModuleController@sendBulkModuleAssignRequest')->middleware('module:module');
        ...
        Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
            ...
            Route::get('get-all-zone-cordinates/{id?}', 'ZoneController@get_all_zone_cordinates')->name('zoneCoordinates');
              Route::get('send-assign-request/{id}/{status}/{name}', 'ZoneController@sendZoneAssignRequest')->name('send-assign-request');
         
	Route::delete('bulk-send-assign-zone-request', 'ZoneController@sendBulkZoneAssignRequest');
        });
