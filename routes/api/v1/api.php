...
Route::group(['namespace' => 'Api\V1', 'middleware' => 'localization'], function () {
    ...
    Route::get('get-all-reviews', 'ReviewController@getAllReviews');
      Route::get('get-all-reviews-test', 'ReviewController@getAllReviewsTest');
    ...
    Route::get('module', 'ModuleController@index');
       Route::post('make-parcel-payment', 'CustomerController@make_parcel_payment');
       Route::post('pay-insurance-amount', 'CustomerController@pay_insurance_amount');
    ...
    Route::group(['prefix' => 'delivery-man'], function () {
        ...
        Route::group(['middleware' => ['dm.api']], function () {
            ...
            Route::post('update-tracking_number', 'DeliverymanController@update_tracking_number');
            ...
            Route::post('add-tracking-data', 'DeliverymanController@add_tracking_data');
            Route::post('add-parcel-info', 'DeliverymanController@add_parcel_information');
    ...
    Route::group(['middleware' => ['module-check']], function () {
        Route::group(['prefix' => 'customer'], function () {
            //download invoice
            Route::get('download-invoice', 'CustomerController@downloadInvoice');
        });
    });
    ...
    Route::group(['middleware' => ['module-check']], function () {
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
	       ...
	       Route::get('get-vehicle-types-by-logistic-type-id/{logistic_type_id}', 'VehicleTypeController@getVehicleTypesByLogisiticTypeId');
            });
            
             Route::group(['prefix' => 'logistic-type'], function () {
            ...
            Route::group(['prefix' => 'commodity-type'], function () {
             ...
             Route::get('parcel-category-detail', 'ParcelCategoryController@getParcelCategoryDetail');
        });
