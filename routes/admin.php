...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
    	 ...
    	 Route::group(['prefix' => 'review', 'as' => 'review.'], function () {
           ...
           // Route::get('status/{id}/{admin_status}/{type}/{user_id}/{review_to_id}', 'ReviewController@update_review_status');
            Route::get('status/{id}/{admin_status}/{type}/{user_id}/{review_to_id?}', 'ReviewController@update_review_status')->name('update-review-status');
        });
        ...
        Route::delete('unit/bulk-item-delete', 'UnitController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'parcel', 'as' => 'parcel.', 'middleware' => ['module:parcel']], function () {
            ...
            Route::get('category/insurance-field-status/{id}/{status}', 'ParcelCategoryController@insuranceFieldStatus')->name('category.insurance-field-status');
        });
        ...
        Route::group(['prefix' => 'employee', 'as' => 'employee.', 'middleware' => ['module:employee']], function () {
            ...
            Route::delete('bulk-item-delete', 'EmployeeController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'item', 'as' => 'item.', 'middleware' => ['module:item']], function () {
            ...
            Route::delete('bulk-item-delete', 'ItemController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'banner', 'as' => 'banner.', 'middleware' => ['module:banner']], function () {
            ...
            Route::delete('bulk-item-delete', 'BannerController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'attribute', 'as' => 'attribute.', 'middleware' => ['module:attribute']], function () {
            ...
            Route::delete('bulk-item-delete', 'AttributeController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
            ...
            Route::group(['middleware' => ['module:store']], function () {
                ...
                Route::delete('bulk-item-delete', 'VendorController@bulk_delete')->name('bulk-item-delete');
                ...
                Route::get('module-wise-list', 'VendorController@module_wise_list')->name('module-wise-list');
        ...
        Route::group(['prefix' => 'addon', 'as' => 'addon.', 'middleware' => ['module:addon']], function () {
            ...
            Route::delete('bulk-item-delete', 'AddOnController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            ...
            Route::group(['middleware' => ['module:category']], function () {
                ...
                Route::delete('bulk-item-delete', 'CategoryController@bulk_delete')->name('bulk-item-delete');
        ...
        Route::group(['prefix' => 'currency', 'as' => 'currency.', 'middleware' => []], function () {
            Route::get('list', 'CurrencyController@index')->name('add-new');
            ...
            Route::get('status/{id}/{status}', 'CurrencyController@status')->name('status');
            Route::delete('delete/{id}', 'CurrencyController@delete')->name('delete');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:settings', 'actch']], function () {
            ...
            Route::get('pages/return-policy', 'BusinessSettingsController@return_policy')->name('return-policy');
            Route::post('pages/return-policy', 'BusinessSettingsController@return_policy_update');

            Route::get('pages/recycling-policy', 'BusinessSettingsController@recycling_policy')->name('recycling-policy');
            Route::post('pages/recycling-policy', 'BusinessSettingsController@recycling_policy_update');
        ...
        Route::group(['prefix' => 'delivery-man', 'as' => 'delivery-man.'], function () {
            ...
            Route::group(['middleware' => ['module:deliveryman']], function () {
                ...
                Route::get('add/{type}', 'DeliveryManController@index')->name('add');
                ...
                Route::get('manage-delivery-agent-module-request/{id}', 'DeliveryManController@manageModuleRequest')->name('manage-delivery-agent-module-request');
                Route::post('approve-delivery-agent-module-request/{id}', 'DeliveryManController@approveModuleRequest')->name('approve-delivery-agent-module-request');
                
                Route::get('manage-delivery-agent-zone-request/{id}', 'DeliveryManController@manageZoneRequest')->name('manage-delivery-agent-zone-request');
		  Route::post('approve-delivery-agent-zone-request/{id}', 'DeliveryManController@approveZoneRequest')->name('approve-delivery-agent-zone-request');

		Route::put('approve-agent/{id}', 'DeliveryManController@approveAgent')->name('approve-agent');
		Route::put('reject-agent/{id}', 'DeliveryManController@rejectAgent')->name('reject-agent');
		
		
		Route::put('approve-employee-status-of-agent/{id}', 'DeliveryManController@approveEmployeeStatusOfAgent')->name('approve-employee-status-of-agent');
		Route::put('reject-employee-status-of-agent/{id}', 'DeliveryManController@rejectEmployeeStatusOfAgent')->name('reject-employee-status-of-agent');
		
                Route::delete('bulk-item-delete', 'DeliveryManController@bulk_delete')->name('bulk-item-delete');
             ...
             Route::group(['middleware' => ['module:delivery_agent']], function () {

                Route::get('add/{type}', 'DeliveryManController@index')->name('add');
                Route::post('store', 'DeliveryManController@store')->name('store');


                Route::get('agent-list', 'DeliveryManController@agentList')->name('agent-list');
        ...
        Route::group(['prefix' => 'user-reviews', 'as' => 'user_reviews.'], function () {
            Route::get('list', 'UserReviewController@index')->name('list');
            Route::get('status/{id}/{status}', 'UserReviewController@reviews_status')->name('status');
        });

        Route::group(['prefix' => 'vehicle-type', 'as' => 'vehicle_type.'], function () {
        
          Route::group(['middleware' => ['module:vehicle_type']], function () {
            Route::get('add-new', 'VehicleTypeController@index')->name('add-new');
            Route::post('store', 'VehicleTypeController@store')->name('store');
            Route::get('edit/{id}', 'VehicleTypeController@edit')->name('edit');
            Route::post('update/{id}', 'VehicleTypeController@update')->name('update');
            Route::get('list', 'VehicleTypeController@list')->name('list');
            Route::delete('delete/{id}', 'VehicleTypeController@delete')->name('delete');
            Route::delete('bulk-item-delete', 'VehicleTypeController@bulk_delete')->name('bulk-item-delete');
            Route::get('status/{id}/{status}', 'VehicleTypeController@status')->name('status');
            Route::get('review-status/{id}/{status}', 'VehicleTypeController@reviews_status')->name('reviews.status');
            Route::post('search', 'VehicleTypeController@search')->name('search');
            Route::get('reviews', 'VehicleTypeController@review_list')->name('reviews');
            Route::get('remove-image', 'VehicleTypeController@remove_image')->name('remove-image');
            Route::get('view/{id}', 'VehicleTypeController@view')->name('view');
            });
        });
        
        Route::group(['prefix' => 'logistic-type', 'as' => 'logistic_type.'], function () {
          Route::group(['middleware' => ['module:logistic_type']], function () {
    	        Route::get('add-new', 'LogisticTypeController@index')->name('add-new');
		Route::post('store', 'LogisticTypeController@store')->name('store');
		Route::get('edit/{id}', 'LogisticTypeController@edit')->name('edit');
		Route::post('update/{id}', 'LogisticTypeController@update')->name('update');
		Route::get('list', 'LogisticTypeController@list')->name('list');
		Route::delete('delete/{id}', 'LogisticTypeController@delete')->name('delete');
		Route::delete('bulk-item-delete', 'LogisticTypeController@bulk_delete')->name('bulk-item-delete');
		Route::get('status/{id}/{status}', 'LogisticTypeController@status')->name('status');
		Route::get('review-status/{id}/{status}', 'LogisticTypeController@reviews_status')->name('reviews.status');
		Route::post('search', 'LogisticTypeController@search')->name('search');
		Route::get('reviews', 'LogisticTypeController@review_list')->name('reviews');
		Route::get('remove-image', 'LogisticTypeController@remove_image')->name('remove-image');
		Route::get('view/{id}', 'LogisticTypeController@view')->name('view');
		});
	});

    Route::group(['prefix' => 'commodity-type', 'as' => 'commodity_type.'], function () {
          Route::group(['middleware' => ['module:logistic_type']], function () {
        Route::get('add-new', 'CommodityTypeController@index')->name('add-new');
        Route::post('store', 'CommodityTypeController@store')->name('store');
        Route::get('edit/{id}', 'CommodityTypeController@edit')->name('edit');
        Route::post('update/{id}', 'CommodityTypeController@update')->name('update');
        Route::get('list', 'CommodityTypeController@list')->name('list');
        Route::delete('delete/{id}', 'CommodityTypeController@delete')->name('delete');
        Route::delete('bulk-item-delete', 'CommodityTypeController@bulk_delete')->name('bulk-item-delete');
    
        Route::post('search', 'CommodityTypeController@search')->name('search');
        Route::get('view/{id}', 'CommodityTypeController@view')->name('view');
        });
    });
    ...
    Route::get('zone/get-sub-zones/{name}', 'ZoneController@get_sub_zones')->name('zone.get-sub-zones');
