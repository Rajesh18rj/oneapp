...
class Helpers
{
    ...
    public static function format_coordiantes($coordinates)
    {
     ...
     public static function module_permission_check_for_delivery_agent($mod_name)
    {
       /* if (!auth('admin')->user()->role) {
            return false;
        }*/

      /*  if ($mod_name == 'zone' && auth('delivery_men')->zone_id) {
            return false;
        }*/
//return false;


	    $role = AdminRole::where('id','8')->first(); // Assuming you have a 'role' relationship defined in your Admin model
	    if ($role) {
		$permission = $role->modules;
		if ($permission && in_array($mod_name, json_decode($permission, true) ?? [])) {
		    return true;
		}
	    }
       ...
       /* if (auth('delivery_men')->delivery_type == 'agent') {
            return true;
        }*/
        return false;
    }
    ...
    public static function module_permission_check($mod_name)
    {
      ...
      public static function modules_permission_check_for_delivery_agent($mod_name)
    {
       /* if (!auth('delivery_men')->user()->role) {
            return false;
        }*/

        if ($mod_name == 'zone' && auth('delivery_men')->user()->zone_id) {
            return false;
        }
