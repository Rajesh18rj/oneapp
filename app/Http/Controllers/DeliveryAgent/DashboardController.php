...
class DashboardController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        return view('delivery-agent-views.dashboard', compact('data', 'total_sell', 'commission', 'params'));
    }
    ...
    public function order(Request $request)
    {
        ...
        return response()->json([
            'view' => view('delivery-agent-views.partials._dashboard-order-stats', compact('data'))->render()
        ], 200);
    }
    ...
    public function zone(Request $request)
    {
        ...
        return response()->json([
            'popular_restaurants' => view('delivery-agent-views.partials._popular-restaurants', compact('popular'))->render(),
            'top_deliveryman' => view('delivery-agent-views.partials._top-deliveryman', compact('top_deliveryman'))->render(),
            'top_rated_foods' => view('delivery-agent-views.partials._top-rated-foods', compact('top_rated_foods'))->render(),
            'top_restaurants' => view('delivery-agent-views.partials._top-restaurants', compact('top_restaurants'))->render(),
            'top_selling_foods' => view('delivery-agent-views.partials._top-selling-foods', compact('top_sell'))->render(),

            'order_stats' => view('delivery-agent-views.partials._dashboard-order-stats', compact('data'))->render(),
            'user_overview' => view('delivery-agent-views.partials._user-overview-chart', compact('data'))->render(),
            'monthly_graph' => view('delivery-agent-views.partials._monthly-earning-graph', compact('total_sell', 'commission'))->render(),
        ], 200);
    }
    ...
    public function user_overview(Request $request)
    {
        ...
        return response()->json([
            'view' => view('delivery-agent-views.partials._user-overview-chart', compact('data'))->render()
        ], 200);
    }
