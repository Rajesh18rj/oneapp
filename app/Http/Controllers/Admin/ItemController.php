...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $item->hsn_image = Helpers::upload('product/', 'png', $request->file('hsn_image'));
        $item->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        $item->batch_number = $request->batch_number;
	$item->expiry_date = $request->expiry_date;
	$item->hsn_image = $request->has('hsn_image') ? Helpers::update('product/', $item->hsn_image, 'png', $request->file('hsn_image')) : $item->hsn_image;
        $item->save();
    ...
    public function bulk_import_data(Request $request)
    {
        ...
        foreach ($collections as $collection) {
                if ($collection['name'] === "" || $collection['category_id'] === "" || $collection['sub_category_id'] === "" || $collection['price'] === "" || $collection['store_id'] === "" || $collection['module_id'] === "" || $collection['batch_number'] === "") {
