...
class CustomerAuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        if ($request['is_received_sms'] == 'no') {
            return response()->json(['message' => 'Please tick the box in condition to receive messages via sms/email/whatsapp'], 200);
        }
        ...
        $response = SMS_module::send($request['phone'], $otp, $templateId);
