...
class Store extends Model
{
    ...
    protected $casts = [
        ...
        'is_fssai_certificate_upload_enabled' => 'boolean',
        'is_pan_card_upload_enabled' => 'boolean',
        'is_tfn_certificate_upload_enabled' => 'boolean',
        'is_acn_certificate_upload_enabled' => 'boolean',
        'is_abn_certificate_upload_enabled' => 'boolean',
        'is_ein_certificate_upload_enabled' => 'boolean',
        'is_cin_certificate_upload_enabled' => 'boolean',
        'is_gst_certificate_upload_enabled' => 'boolean'
    ];
